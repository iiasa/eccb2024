...
# Understand conservation planning problem
...
For our first problem we will create a problem that finds the best areas for 30% protected area coverage on European land. Go to the next section (@sec-solving-a-problem) to learn how to solve and interpret the outputs from a prioritizr problem.
